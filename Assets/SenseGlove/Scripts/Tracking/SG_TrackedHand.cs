...
namespace SG
{
    ...
    public class SG_TrackedHand : MonoBehaviour
    {
        ...
        protected virtual void SetupTracking(Transform newTarget, TrackingHardware trackType, TrackingMethod trackMethod, bool rightHand)
        {
            ...
            this.SetTrackedObject(newTarget, trackType);
        ...
        public void SetTrackedObject(Transform newTarget, TrackingHardware hardware = TrackingHardware.Custom)
        {
            ...
            if (trackedObject != null)
            {
                ...
                {
                    bool rightHand = this.TracksRightHand;
